...
if (pathName === '/') {
  $(document).ready(function(){
      if ( $("#bber-talk").length > 0 ) {
        ...
        // var bberHtml = a+b ;
        $('#bber-talk').append('<span class="index-talk-icon" style="margin-right: 5px"><i class="fas fa-bullhorn" style="color: #FF0000;animation: announ_animation .8s linear infinite"></i></span><ul class="talk-list"><li class="item item-1">欢迎来到我的博客，来和我一起学习吧 o(*￣▽￣*)ブ</li><li class="item item-2" >我很菜，有错误还望及时指出，十分感谢</li></ul>');
